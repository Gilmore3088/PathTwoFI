          ...
          >
            ...
            {!loading && !isSuccessfullyUploaded && (
              <Button
                size="icon"
                variant="link"
                className="shrink-0 justify-self-end text-muted-foreground hover:text-foreground pointer-events-auto"
...
const DropzoneEmptyState = ({ className }: { className?: string }) => {
  const { maxFiles, maxFileSize, open, isSuccess } = useDropzoneContext()
      ...
      <div className="flex flex-col items-center gap-y-1">
        <p className="text-xs text-muted-foreground">
          ...
          <button
            type="button"
            onClick={open}
            className="underline cursor-pointer transition hover:text-foreground pointer-events-auto"
          >
