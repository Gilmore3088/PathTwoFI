        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-16">
            <CardContent className="p-8">
              ...
              <p
                ...
                data-testid="text-mission-goal"
              >
                The goal isn't just to reach FIRE, but to inspire other couples
                to take control of their financial future and show that
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <principle.icon
                        ...
                        data-testid={`icon-principle-${index}`}
                      />
                      <h3
                        className="text-lg font-semibold text-foreground"
                        data-testid={`text-principle-title-${index}`}
                      >
                        {principle.title}
                      </h3>
                    </div>
                    <p
                      ...
                      data-testid={`text-principle-description-${index}`}
                    >
          ...
          <Card className="mb-16">
            <CardContent className="p-8">
              ...
              <p
                className="text-lg text-muted-foreground leading-relaxed mb-4"
                data-testid="text-transparency-content"
              >
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-6">
                <div
                  ...
                  data-testid="card-transparency-real-data"
                >
                ...
                <div
                  className="text-center p-4 bg-muted/30 rounded-lg"
                  data-testid="card-transparency-honest-mistakes"
                >
                ...
                <div
                  className="text-center p-4 bg-muted/30 rounded-lg"
                  data-testid="card-transparency-regular-updates"
                >
